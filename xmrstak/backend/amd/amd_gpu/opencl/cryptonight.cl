...
#if(ALGO==11 && defined(__NV_CL_C_VERSION) || ALGO==13 && defined(__NV_CL_C_VERSION))
...
// cryptonight_monero_v8 && cryptonight_pulse8
#if(ALGO==11 || ALGO==13)
...
#endif
// cryptonight_pulse8
#if(ALGO==13 && (defined(__clang__) && !defined(__NV_CL_C_VERSION)))
		RCP[i] = RCP_C[i];
#endif
    }
...
#endif 
// cryptonight_pulse8 && NVIDIA 
#if(ALGO==13 && defined(__NV_CL_C_VERSION))
			uint idxS = idx0 & 0x30U;
 			*scratchpad_line = SCRATCHPAD_CHUNK_GLOBAL;
#endif 
